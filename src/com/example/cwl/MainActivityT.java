...
public class MainActivityT extends FragmentActivity implements ActionBar.TabListener {
...
//		ActionBar.Tab settingsTab = actionBar.newTab().setText(R.string.settins);
	...
	private void initView() {
		...
		homepageFragment = new FragmentHomepageT();
		profileFragment = new FragmentProfileT();
		notifFragment = new FragmentNotifyT();
		settingsFragment = new FragmentSettingsT();
